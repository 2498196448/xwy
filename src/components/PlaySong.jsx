...
export default function PlaySong() {
  ...
  return (
    <Div className="page  bg-[skyblue] pb-[100px]">
      {songDetail &&
        songDetail.map((res) => {
          return (
            <div className="w-[100%]">
              <div className="nav h-[15vw] w-[100%] flex px-[4vw] box-border items-center justify-between">
                ...
                <div className="w-[60vw] flex flex-col items-center justify-center">
                  ...
                  <div className="flex mt-[1vw] items-center">
                    {res.ar.map((data) => {
                      return <p className="text-[2.8vw] text-[#bcbfbf]">{data.name}</p>;
                    })}
                    <p
                      style={{ borderRadius: '8px' }}
                      className="text-[2vw] bg-[#84868b] text-[#d8d8d8] w-[36px] h-[20px] leading-[20px] ml-[1vw] text-center"
                    >
                      关注
                    </p>
                  </div>
              ...
              <div className="h-[120vw] w-[100%] overflow-hidden relative">
                <img
                  ...
                  style={
                    isPlaying ? { transform: 'rotate(-45deg)' } : { transform: 'rotate(-5deg)' }
                  }
                />
                <div
